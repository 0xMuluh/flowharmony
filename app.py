...
FEEDBACK_SCREENS: List[Dict[str, object]] = [
    {
        ...
        "response_key": "smell",
        "title": "👃 Smell Check",
        "prompt": "How inviting does the dish smell right now?",
        "options": [
            {"value": "1", "label": "😶 Flat"},
            {"value": "3", "label": "😊 Nice"},
            {"value": "5", "label": "🤩 Show-stopper"},
        ],
        "button_text": "Send aroma rating",
        "success_text": "Thanks – chef will keep the aroma on point!",
    },
    {
        "slug": "appearance",
        "question_set": "sensory",
        ...
        "title": "👀 Plate Appeal",
        "prompt": "How good does the dish look on your tray?",
        "options": [
            {"value": "1", "label": "😐 Needs love"},
            {"value": "3", "label": "😀 Looks good"},
            {"value": "5", "label": "🌟 Picture-perfect"},
        ],
        "button_text": "Share plate look",
        "success_text": "Noted – plating team will love this!",
    },
    {
        "slug": "temperature",
        "question_set": "sensory",
        "response_key": "temperature",
        "title": "🌡️ Temperature Feel",
        "prompt": "Temperature feels…",
        "options": [
            {"value": "too_cold", "label": "🥶 Too cold"},
            {"value": "just_right", "label": "😌 Just right"},
            {"value": "too_hot", "label": "🔥 Too hot"},
        ],
        "button_text": "Submit temperature",
        "success_text": "Thanks – we'll adjust the heat lamps!",
    },
    {
        "slug": "wait",
        "question_set": "queue",
        ...
        "title": "⏱️ Wait Check",
        "prompt": "How was your wait just now?",
        "options": [
            {"value": "quick", "label": "🚀 Super quick"},
            {"value": "ok", "label": "🙂 Acceptable"},
            {"value": "too_long", "label": "⏳ Too long"},
        ],
        "button_text": "Share wait time",
        "success_text": "Thanks – flow captain notified!",
    },
    {
        "slug": "flow",
        "question_set": "queue",
        "response_key": "flow_speed",
        "title": "🚶‍♀️ Line Movement",
        "prompt": "Describe the line movement",
        "options": [
            {"value": "smooth", "label": "🟢 Smooth"},
            {"value": "stop_and_go", "label": "🟡 Stop & go"},
            {"value": "stalled", "label": "🔴 Stalled"},
        ],
        "button_text": "Send line status",
        "success_text": "Flow crew will pivot right away!",
    },
    {
        "slug": "staff",
        "question_set": "queue",
        ...
        "title": "🤝 Staff Warmth",
        "prompt": "How friendly was the team just now?",
        "options": [
            {"value": "1", "label": "😶"},
            {"value": "3", "label": "🙂"},
            {"value": "5", "label": "🤗"},
        ],
        "button_text": "Send shout-out",
        "success_text": "Thanks – we love sharing the kudos!",
    },
    {
        "slug": "portion",
        "question_set": "value",
        "response_key": "portion_size",
        "title": "🍽️ Portion Size",
        "prompt": "Portion feels…",
        "options": [
            {"value": "too_light", "label": "🥄 Too light"},
            {"value": "just_right", "label": "🍛 Just right"},
            {"value": "too_heavy", "label": "🍱 Too much"},
        ],
        "button_text": "Send portion note",
        "success_text": "Appreciated – we'll balance the scoop!",
    },
    {
        "slug": "value",
        "question_set": "value",
        ...
        "title": "💶 Value Pulse",
        "prompt": "Value for money right now",
        "options": [
            {"value": "1", "label": "💔 Low"},
            {"value": "3", "label": "🙂 Fair"},
            {"value": "5", "label": "🤩 Excellent"},
        ],
        "button_text": "Send value vibe",
        "success_text": "Thanks – finance loves this signal!",
    },
    {
        "slug": "mood",
        "question_set": "value",
        ...
        "title": "😊 Mood Meter",
        "prompt": "Leaving the counter feeling…",
        "options": [
        ...
        "success_text": "Got it – we'll keep the mood high!",
    },
]
